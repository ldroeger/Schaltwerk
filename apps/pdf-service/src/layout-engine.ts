...
export type TopologyNodeType =
  | "EINSPEISUNG" | "HAUPTSCHALTER" | "ZAEHLER" | "PV_ZAEHLER" | "WAERMEPUMPE_ZAEHLER"
  | "UNTERVERTEILER" | "SAMMELSCHIENE" | "RCD" | "LS_SCHALTER" | "RELAIS" | "SCHUETZ"
  | "DIREKTVERBINDER" | "KLEMME" | "VERBRAUCHER" | "KNX_LINIE";
...
const SYMBOL_HEIGHT_MM: Record<TopologyNodeType, number> = {
  EINSPEISUNG: 10, HAUPTSCHALTER: 10, ZAEHLER: 10, PV_ZAEHLER: 10, WAERMEPUMPE_ZAEHLER: 10,
  UNTERVERTEILER: 12, SAMMELSCHIENE: 4,
  RCD: 16, LS_SCHALTER: 8, RELAIS: 8, SCHUETZ: 10, DIREKTVERBINDER: 4,
  KLEMME: 6, VERBRAUCHER: 8, KNX_LINIE: 8,
};
